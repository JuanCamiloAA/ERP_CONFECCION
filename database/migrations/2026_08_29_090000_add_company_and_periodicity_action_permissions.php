...
/**
 * Permisos de las acciones nuevas de Empresas y Periodicidad de pagos.
 *
 * Exportar empresas ya se podia hacer a ojo copiando la tabla, pero ahora hay un boton y una
 * ruta: sin permiso propio quedaria cubierto por `companies.index.view`, que es justo la
 * mezcla que se deshizo en la revision anterior. Reordenar y activar/desactivar
 * periodicidades salen de `edit` por el mismo motivo y siguiendo lo que ya hace
 * `payroll_concepts`.
 *
 * Como en la migracion de permisos granulares, cada permiso nuevo se concede a quien ya
...
return new class extends Migration
{
    ...
    protected const INHERITS_FROM = [
        'companies.index.export' => 'companies.index.view',
        'payroll_periodicities.index.reorder' => 'payroll_periodicities.index.edit',
        'payroll_periodicities.index.toggle' => 'payroll_periodicities.index.edit',
    ];
